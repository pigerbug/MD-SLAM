...
namespace ORB_SLAM2 {
    ...
    public:
        //ovd add
        std::thread* mptYoloDetector;
        std::vector<double> EpiErr_total;
        void GetEpierr(std::vector<double>& EpiErr_total);
        void Getfenbu(std::vector<double>& fenbu_total);
        void Getcal_f_num(std::vector<int>& cal);
